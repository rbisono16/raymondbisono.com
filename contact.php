...
$address = 'hola@raymondbisono.com';
...
if(mail($address, $e_subject, $msg, $headers)) { echo "<fieldset><div id='success_page'><p>Gracias $name, tu mensaje ha sido enviado.</p></div></fieldset>"; }